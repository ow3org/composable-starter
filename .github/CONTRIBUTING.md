...
First off, thank you for taking the time to contribute to Open Web Foundation ❤️
...
Head over to the [repository][composable-starter] on GitHub and click the Fork button in the top
right corner. After the project has been forked, run the following commands in your terminal:

```bash
# Replace {github-username} with your GitHub username.
$: git clone https://github.com/{github-username}/composable-starter --depth=1

$: cd composable-starter
...
$: git remote add upstream git@github.com:openweblabs/composable-starter.git
...
Each of our composable comes with test cases. Feel free to check them out within the `./test` root folder. When adding or or updating functionality, please ensure it is covered through tests and that new tests pass when running `pnpm test`.
...
When you're all done head over to the [repository][composable-starter], and click the big green
...
[composable-starter]: https://github.com/openweblabs/composable-starter
